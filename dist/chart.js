...
const Chart = ({ data, type, width = 600, height = 350 }) => {
    ...
    const renderLegend = () => (createElement("div", { style: {
            marginTop: "12px",
            display: "flex",
            justifyContent: "center",
            flexWrap: "wrap",
            gap: "12px",
        } }, data.map((d, i) => (createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: "6px" } },
        ...
        createElement("span", { style: { fontSize: "13px", color: "#374151" } }, d.label))))));
    return (createElement("div", { style: { position: "relative", textAlign: "center" } },
        createElement("canvas", { ref: canvasRef, width: width, height: height, style: { borderRadius: "10px" } }),
